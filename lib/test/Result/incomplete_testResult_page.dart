            ...
            Row(
              children: [
                ...
                Column(
                  ...
                  children: [
                    Text(
                      "Your test will not be noted as completed as you exceeded",
                      style:
                          TextStyle(color: Color(0xffD1BD50), fontSize: 12.5),
                    ),
                    Text(
                      "the time limit for the exam . Try taking the test again .",
                      style:
                          TextStyle(color: Color(0xffD1BD50), fontSize: 12.5),
                    ),
                  ],
