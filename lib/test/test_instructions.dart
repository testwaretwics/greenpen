      ...
      body: Padding(
        ...
        child: ListView(
          children:[
              ...
              RoundedButton(text: "Start Test", press: (){
                isChecked? Get.to(()=>TestPage()):Get.snackbar("", "agree the terms and conditions",colorText:Colors.white,backgroundColor: Colors.blue);
