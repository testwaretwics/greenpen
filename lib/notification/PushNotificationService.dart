  ...
  registerNotificationListeners() async {
    ...
    flutterLocalNotificationsPlugin.initialize(initSettings,
        onSelectNotification: (message) async {
          ...
          //   if(Get.put(GetDriverOfflineBookingLeadsController()).bookingForDriverData == true) {
          //     Get.toNamed(ROUTE_DASHBOARD);
          //     Get.put(DashboardController()).tabIndex = 2;
          //     Get.put(DashboardController()).update();
          //     if (Get.put(GetDriverOfflineBookingLeadsController()).driverId == null) {
          //       Get.put(CheckGetServiceProviderSignInStatusController())
          //           .masterLoginNewForMyBookingsApiData();
          //     }
          //     Get.put(GetDriverOfflineBookingLeadsController())
          //         .getDriverOfflineBookingLeadsApiData(
          //         Get.put(GetDriverOfflineBookingLeadsController()).driverId);
          //     Get.put(GetDriverOfflineBookingLeadsController()).update();
          //   }
          //
          //
          ...
          //   if(Get.put(GetDriverOfflineBookingLeadsController()).bookingForDriverData == true) {
          //     Get.toNamed(ROUTE_DASHBOARD);
          //     Get.put(DashboardController()).tabIndex = 1;
          //     Get.put(DashboardController()).update();
          //     Get.put(GetSlaveOfflineBookingLeadsController())
          //         .getSlaveOfflineBookingLeadsApiData();
          //     Get.put(GetDriverOfflineBookingLeadsController()).update();
          //   }else if(Get.put(GetDriverOfflineBookingLeadsController()).bookingForDriverData == false) {
          //     Get.toNamed(ROUTE_DASHBOARD);
          //     Get.put(DashboardController()).tabIndex = 1;
          //     Get.put(DashboardController()).update();
          //     Get.put(GetSlaveOfflineBookingLeadsController())
