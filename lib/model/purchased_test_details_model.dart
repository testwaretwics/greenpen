class PurchasedTestDetailsModel {
  bool? status;
  String? message;
  Result? result;

  PurchasedTestDetailsModel({this.status, this.message, this.result});

  PurchasedTestDetailsModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
